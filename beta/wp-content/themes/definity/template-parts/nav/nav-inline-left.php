<?php
/**
 * The template part for displaying: Navigation Menu - Inline Left
 *
 * @package Definity
 * @version 2.0
 */
...
<nav class="d-nav-inline d-nav-c-style <?php 
...
?>">
	...
	<?php if ( isset( $navbar_grid_on ) && $navbar_grid_on == false ); else echo '<div class="d-nav-grid">'; ?>
	...
	<?php if ( isset( $navbar_grid_on ) && $navbar_grid_on == false ); else echo '</div>'; ?>
</nav><!-- / .navbar -->