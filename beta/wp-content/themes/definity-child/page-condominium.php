...
?>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="one">
              ...
              <a href="<?php echo site_url() . '/vividhotel';?>" role="button" aria-haspopup="true" aria-expanded="false">HOTEL</a>
                            ...
                            <li class="four">
              <a href="<?php echo site_url() . '/vividresidence';?>" role="button" aria-haspopup="true" aria-expanded="false">Service Apartment</a>
            </li>
    ...
    <div id="t_pages" class="condominiums" style="padding-top: 91px;">
        <div class="banner" style="background-image: url(<?php echo site_url(). '/wp-content/uploads/2018/04/Untitled-4.png'; ?>);">
                <img src="<?php echo site_url(). '/wp-content/uploads/2018/04/vivid-residence-banner.jpg'; ?>" alt="Project Example">
        </div>
        <div class="common-desc wow fadeInUp" style="width: 70%; padding-bottom: 1em;">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eos corporis magnam sunt, ut possimus aliquam. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Praesentium corporis eveniet, unde qui dolores veniam.</p>
        </div>
