<?php
/**
 * The template part for displaying: Navigation Menu - Stacked Center
 *
 * @package Definity
 * @version 2.0
 */
...
<nav class="d-nav-stacked d-nav-stacked-center d-nav-c-style <?php if ( isset( $d_navbar_class ) ) echo esc_attr( $d_navbar_class ); ?>">
